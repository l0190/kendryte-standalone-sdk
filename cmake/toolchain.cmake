...
if (WIN32)
    #Add Ninja Support:download Ninja.exe to the path where the Toolchain resides
    if(EXISTS "${TOOLCHAIN}/ninja${EXT}")
        global_set(CMAKE_MAKE_PROGRAM "${TOOLCHAIN}/ninja${EXT}")
    elseif(EXISTS "${TOOLCHAIN}/make${EXT}")
